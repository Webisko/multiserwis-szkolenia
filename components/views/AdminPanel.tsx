...
import { Course, Student, StudentUser, ViewState } from "../../types";
...
interface AdminPanelProps {
  ...
  onCreateUser: (payload: any) => { ok: true } | { ok: false; error: string };
  ...
  return (
    ...
    >
      ...
      {activeSection === "finance" && (
        <AdminFinance courses={courses} students={students} />
      )}
